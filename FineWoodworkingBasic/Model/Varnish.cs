...
namespace FineWoodworkingBasic.Model
{
    public class Varnish : InventoryItem
    {
        ...
        public Varnish(string name, string notes, string fileImg1, string fileImg2, string fileImg3,
        ...
        protected override void SetupCommandForInsert(QC.SqlCommand command)
        {
            ...
            string insertQuery = "INSERT INTO Varnish (Name, Notes, LinkImg1, LinkImg2, LinkImg3, Qty, LocationID, MatertialType, BrandID) " +
                " OUTPUT INSERTED.ID " +
            ...
            parameter = new QC.SqlParameter("@MaterialType", DT.SqlDbType.NVarChar, 50); // Fix Type and Length  
        ...
        protected override void SetupCommandForDelete(QC.SqlCommand command)
        {
            ...
            string deleteQuery = "DELETE FROM Varnish " +
                " (WHERE ID = @ID)";
        ...
        protected override void SetupCommandForUpdate(QC.SqlCommand command)
        {
            ...
            string updateQuery = "UPDATE Varnish" +
        ...
        {
            ResultMessage mesg = new ResultMessage(ResultMessage.ResultMessageType.Error, "Error in saving Varnish with Name: " + this.Name +
                " into database!");
            return mesg;
        }
        ...
        {
            ResultMessage mesg = new ResultMessage(ResultMessage.ResultMessageType.Error, "Error in deleting Varnish with Name: " + this.Name +
                " from database!");
            return mesg;
        }
