...
namespace FineWoodworkingBasic.Model
{
    public class Paint : InventoryItem
    {
        ...
        protected override void ConstructPopulateQueryCommand(Dictionary<string, Object> dictIdToUse, QC.SqlCommand command)
        {
            ...
            string query = @"SELECT * FROM Paint WHERE (ID = @Id);";
        ...
        {
            ResultMessage mesg = new ResultMessage(ResultMessage.ResultMessageType.Error, "Error in retrieving Paint with Name: " + this.Name +
                " from database!");
            return mesg;
        }
